      ...
      <main style={{ maxWidth: '980px', margin: '0 auto', padding: 'clamp(110px,13vh,160px) clamp(20px,4vw,56px) clamp(70px,11vh,130px)' }}>
        ...
        <RevealOnScroll>
          ...
          <p style={{ fontSize: '14.5px', color: '#2B2520', fontWeight: 600, margin: '0 0 24px' }}>
            Last updated: <span style={{ fontWeight: 400 }}>August 28, 2026</span>
          </p>

          <p style={{ fontSize: '15.5px', lineHeight: 1.8, color: '#4A423A', fontWeight: 300, margin: '0 0 16px' }}>
            Iva Essentials operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). Iva Essentials is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
          </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '54px' }}>
          ...
          <RevealOnScroll>
            <section>
              ...
              <ul style={{ paddingLeft: '22px', margin: 0, display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '15.5px', color: '#3A332C', lineHeight: 1.75 }}>
          ...
          <RevealOnScroll>
            <section>
              ...
              <ul style={{ paddingLeft: '22px', margin: 0, display: 'flex', flexDirection: 'column', gap: '14px', fontSize: '15.5px', color: '#3A332C', lineHeight: 1.75 }}>
          ...
          <RevealOnScroll>
            <section>
              ...
              <p style={{ fontSize: '15.5px', lineHeight: 1.8, color: '#3A332C', margin: 0, fontWeight: 300 }}>
                To learn more about how Shopify uses your personal information and any rights you may have, you can visit the <a href="https://www.shopify.com/legal/privacy/app-users" target="_blank" rel="noreferrer" style={{ color: '#A2543A', textDecoration: 'underline' }}>Shopify Consumer Privacy Policy</a>. Depending on where you live, you may exercise certain rights with respect to your personal information here <a href="https://privacy.shopify.com/en" target="_blank" rel="noreferrer" style={{ color: '#A2543A', textDecoration: 'underline' }}>Shopify Privacy Portal Link</a>.
              </p>
            </section>
          </RevealOnScroll>
          ...
          <RevealOnScroll>
            <section>
              ...
              <ul style={{ paddingLeft: '22px', margin: '0 0 16px', display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '15.5px', color: '#3A332C', lineHeight: 1.75 }}>
              ...
              <p style={{ fontSize: '15.5px', lineHeight: 1.8, color: '#3A332C', margin: '0 0 16px', fontWeight: 300 }}>
                You may exercise any of these rights where indicated on the Services or by contacting us using the contact details provided below. To learn more about how Shopify uses your personal information and any rights you may have, including rights related to data processed by Shopify, you can visit <a href="https://privacy.shopify.com/en" target="_blank" rel="noreferrer" style={{ color: '#A2543A', textDecoration: 'underline' }}>https://privacy.shopify.com/en</a>.
              </p>
              <p style={{ fontSize: '15.5px', lineHeight: 1.8, color: '#3A332C', margin: 0, fontWeight: 300 }}>
          ...
          <RevealOnScroll>
            <section>
              ...
              <div style={{ background: '#EFE7DA', border: '1px solid rgba(23,19,15,.12)', padding: '24px 28px', borderRadius: '4px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <strong style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '22px', color: '#17130F' }}>Iva Essentials</strong>
                <span style={{ fontSize: '14.5px', color: '#3A332C' }}>Phone: <a href="tel:+919063448273" style={{ color: '#A2543A', textDecoration: 'underline' }}>+91 90 6344 8273</a></span>
                ...
                <span style={{ fontSize: '14.5px', color: '#3A332C', lineHeight: 1.6, marginTop: '4px' }}>
                  Address: Dreamscape Hotel - Banjara Hills Road Number 12 MLA Colony Banjara Hills, Dreamscape Hotels, 500034 Hyderabad TS, India
                </span>
              </div>
            </section>
          </RevealOnScroll>
